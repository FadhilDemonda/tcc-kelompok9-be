...
router.post("/laporan", createLaporan); // Create new laporan
router.put("/laporan/:id", updateLaporan); // Update laporan (full update)
router.patch("/laporan/:id/status", updateStatusLaporan); // Update status laporan only
router.delete("/laporan/:id", deleteLaporan); // Delete laporan
